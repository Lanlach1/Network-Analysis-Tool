...
save_data_path = "C:/Python_Programs/NMJ_edge_ana_data\MFPT_NMJ_Network 1.xlsx"
...
save_graph_path = "C:/Python_Programs/Movie_File" #name of file you want to save graph to. Will save in both PDF and PNG form.
class Network:
