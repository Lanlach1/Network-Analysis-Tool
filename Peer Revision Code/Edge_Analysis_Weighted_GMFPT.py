...
save_data_path = 'C:/Python_Programs/Fai_ER_Project/Peer_Revision_Work/Final Graph Edits 3/MFPT_S2_Network 10 weight.xlsx'
image_path = 'C:/Python_Programs/Fai_ER_Project/12_27_S2Cell1460_Image/S2Cell1460_im10.png' #if you extracted network from an image you can use it as a backround, if no image put None.
...
name = "S2 10 weight" #name of network, will be used for naming files and such
