...
save_data_path = 'C:/Python_Programs/Fai_ER_Project/Peer_Revision_Work/Final Graph Edits 2/MFPT_NMJ_Network 100 weight.xlsx'
image_path = 'C:/Python_Programs/Fai_ER_Project/NMJ_middle2/NMJ_middle2_im100.png' #if you extracted network from an image you can use it as a nackround, if no image put None.
...
edge_path = 'C:/Python_Programs/Fai_ER_Project/NMJ_middle2/NMJ_middle2_edges100.xls' #excel file containing adjecency matrix of network. Please look at examples in Github Repo for reference.
node_path = 'C:/Python_Programs/Fai_ER_Project/NMJ_middle2/NMJ_middle2_verts100.xls'#excel file conatining x y coordinates of all nodes within network. Look at github repo for examples.
name = "NMJ 100 weighted" #name of network, will be used for naming files and such
